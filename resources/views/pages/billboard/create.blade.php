...
@section('page-title')
    <div class="row ms-md-2 d-md-flex flex-md-wrap flex-lg-nowrap">
        <div class="col-12 col-md-7 my-auto">
            <h1 class="ms-2 mb-0 text-main-color-2" style="width: 400px;">Media <small class="fs-4">/ Billboard / Create</small></h1>
        </div>
    </div>
@stop
        ...
        <div class="mb-5 mb-lg-4 row">
            ...
            <div class="col-12 col-lg-3 ps-lg-3 order-lg-2">
                <div class="row mb-4">
                    ...
                    <div class="col-sm-12 col-lg-12">
                        <input type="color" name="color" class="form-control form-control-color d-inline-block" id="background-color-select" value="#FFFFFF" title="Choose background color">
                    </div>
                </div>
            </div>
