                ...
                <tr>
                    ...
                    <td>
                        ...
                        <label class="d-flex justify-content-center align-items-center">
                            <input class="d-none-cloaked station-isactive" type="checkbox" name="isactive"
                                value="{{ $station->id }}" @checked(old('isactive', $station->isactive == 'Y'))>
                            <i class="switch-icon switch-icon-success switch-icon-sm"></i>
                            {{-- <span class="px-2 user-select-none">{{ $station->isactive == 'Y' ? 'On' : 'Off'
                                }}</span> --}}
                        </label>
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <a href="https://www.google.co.th/maps/dir//{{ $station['google_map'] }}" target="_blank"><i
                    ...
                    <td class="text-end">
                        ...
                        <x-action-edit class="me-2" :url="route('edit-station', ['id' => $station['id']])"
                            id="btn-station-edit" />
                        <x-action-delete :url="route('station-delete', ['id' => $station['id']])"
