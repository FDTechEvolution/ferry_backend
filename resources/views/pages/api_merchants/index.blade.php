                    ...
                    @foreach ($apiMerchants as $index => $apiMerchant)
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="avatar avatar-md rounded-circle" style="background-image:url({{asset($apiMerchant->image->path)}})"></div>
                                @endif
                            </td>
                            ...
                            <td class="text-center">
                                ...
                                <span class="text-success">
                                    <svg width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-patch-check-fill" viewBox="0 0 16 16">
                            ...
                            <td class="text-center">
                                @if ($apiMerchant->isopendiscount =='Y')
                                <span class="text-success">
                                    <svg width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-patch-check-fill" viewBox="0 0 16 16">
                                        <path d="M10.067.87a2.89 2.89 0 0 0-4.134 0l-.622.638-.89-.011a2.89 2.89 0 0 0-2.924 2.924l.01.89-.636.622a2.89 2.89 0 0 0 0 4.134l.637.622-.011.89a2.89 2.89 0 0 0 2.924 2.924l.89-.01.622.636a2.89 2.89 0 0 0 4.134 0l.622-.637.89.011a2.89 2.89 0 0 0 2.924-2.924l-.01-.89.636-.622a2.89 2.89 0 0 0 0-4.134l-.637-.622.011-.89a2.89 2.89 0 0 0-2.924-2.924l-.89.01-.622-.636zm.287 5.984-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7 8.793l2.646-2.647a.5.5 0 0 1 .708.708z"></path>
                                      </svg>
                            ...
                            <td class="text-end">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <a href="#" data-href="{{ route('api.editMerchant',['id'=>$apiMerchant->id]) }}" data-ajax-modal-size="modal-md"
                                    data-ajax-modal-centered="true" data-ajax-modal-callback-function="" data-ajax-modal-backdrop="static"
                                        class="btn btn-sm btn-primary js-ajax-modal"><i class="me-0 fa-solid fa-pen-to-square"></i></a>
