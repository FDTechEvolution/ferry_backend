<div class="card-body">
    ...
    <form novalidate class="bs-validate" id="route-map-edit-form" method="POST" action="{{ route('route-map-update') }}"
        ...
        <fieldset id="route-map-edit">
            <div class="mb-4 row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 text-center">
                                    ...
                                    <a href="javascript:void(0)" title="Clear Images" data-bs-toggle="tooltip"
                                        onClick="restoreCurrentImageByUpload('current-image')" id="remove-picture-edit"
                            ...
                            <div class="row d-none" id="current-image">
                                <div class="col-12">
                                    <div class="position-relative hide-empty mt-2">
                                        <div
                                            class="d-flex clearfix position-relative show-hover-container shadow-md mb-2 rounded">
                                            <div class="position-relative d-inline-block bg-cover"
                                                id="edit-image-cover">
                                                <img src="" id="edit-image-src" class="animate-bouncein mw-100">
                                            </div>
                                            <div class="flex-fill d-flex min-w-0 align-items-center"
                        ...
                        <div class="col-sm-12 col-lg-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 text-center">
                                    <!-- remove button -->
                                    <a href="javascript:void(0)" title="Clear Images" data-bs-toggle="tooltip"
                                        onClick="restoreCurrentImageByUpload('current-banner')" id="remove-banner-edit"
                            ...
                            <div class="row d-none" id="current-banner">
                                <div class="col-10">
                                    <div class="position-relative hide-empty mt-2">
                                        <div
                                            class="d-flex clearfix position-relative show-hover-container shadow-md mb-2 rounded">
                                            <div class="position-relative d-inline-block bg-cover"
                                                id="edit-banner-cover">
                                                <img src="" id="edit-banner-src" class="animate-bouncein mw-100">
                                            </div>
                                            <div class="flex-fill d-flex min-w-0 align-items-center"
                                                style="padding-left:15px;padding-right:15px;">
                                                <span class="text-truncate d-block line-height-1">Current picture
                                                    banner</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-2 text-center">
                                    <!-- remove button -->
                                    <a href="JavaScript:void(0);" title="Delete Images" data-bs-toggle="tooltip"
                                        onClick="deleteCurrentImage('current-banner', 'has-banner', 'restore-banner')"
                            ...
                            <svg id="restore-banner" title="Restore Images" data-bs-toggle="tooltip"
                                onClick="restoreCurrentImage('current-banner', 'has-banner', 'restore-banner')"
                                width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="bi bi-arrow-counterclockwise d-none cursor-pointer" viewBox="0 0 16 16">
                        ...
                        <div class="col-sm-12 col-lg-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 text-center">
                                    <!-- remove button -->
                                    <a href="javascript:void(0)" title="Clear Images" data-bs-toggle="tooltip"
                                        onClick="restoreCurrentImageByUpload('current-thumb')" id="remove-thumb-edit"
                            ...
                            <div class="row d-none" id="current-thumb">
                                ...
                                <div class="col-2 text-center">
                                    <!-- remove button -->
                                    <a href="JavaScript:void(0);" title="Delete Images" data-bs-toggle="tooltip"
                                        onClick="deleteCurrentImage('current-thumb', 'has-thumb', 'restore-thumb')"
                                        class="btn btn-secondary mt-4 text-center">
                                        <i class="fi fi-close mx-auto"></i>
                                    </a>
                                </div>
                            ...
                            <svg id="restore-thumb" title="Restore Images" data-bs-toggle="tooltip"
                                onClick="restoreCurrentImage('current-thumb', 'has-thumb', 'restore-thumb')"
                                width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="bi bi-arrow-counterclockwise d-none cursor-pointer" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                                    d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2v1z"></path>
                ...
                <div class="col-sm-12 col-lg-6">
                    <div class="mb-3 row">
                        <label class="col-sm-12 col-lf-3 col-form-label-sm text-lg-end text-light fw-bold">Detail
                            :</label>
                        <div class="col-sm-12 col-lg-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-4">
                            <input type="number" class="form-control form-control-sm text-center"
                                id="route-map-sort-edit" name="sort">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-2 row">
                <div class="col-12 justify-content-end d-flex align-items-end">
                    <x-button-submit-loading class="btn-sm w--10 me-2 button-green-bg border-radius-10"
                        :form_id="_('route-map-edit-form')" :fieldset_id="_('route-map-edit')" :text="_('Update')" />
                    <button type="button" id="btn-cancel-route-map-edit"
                        class="btn btn-light btn-sm w--10 align-self-end border-radius-10">Cancel</button>
