                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="row d-none" id="current-icon">
                                    ...
                                    <div class="col-2 text-center">
                                        <!-- remove button -->
                                        <a href="JavaScript:void(0);" title="Delete Icon" data-bs-toggle="tooltip" onClick="deleteCurrentImage('current-icon', 'has-icon', 'restore-icon')" class="btn btn-secondary mt-4 text-center">
                                            <i class="fi fi-close mx-auto"></i>
                                        </a>
                                    </div>
                                </div>
                                <svg id="restore-icon" title="Restore Icon" data-bs-toggle="tooltip" onClick="restoreCurrentImage('current-icon', 'has-icon', 'restore-icon')" width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-arrow-counterclockwise d-none cursor-pointer" viewBox="0 0 16 16">  
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="row d-none" id="current-image">
                                    ...
                                    <div class="col-2 text-center">
                                        <!-- remove button -->
                                        <a href="JavaScript:void(0);" title="Delete Images" data-bs-toggle="tooltip" onClick="deleteCurrentImage('current-image', 'has-image', 'restore-image')" class="btn btn-secondary mt-4 text-center">
                                            <i class="fi fi-close mx-auto"></i>
                                        </a>
                                    </div>
                                </div>
