<div class="card-body">
    ...
    <form novalidate class="bs-validate" id="route-map-create-form" method="POST" action="{{ route('route-map-create') }}" enctype="multipart/form-data">
        @csrf
        <fieldset id="route-map-create">
            <div class="mb-4 row">
                        ...
                        <div class="col-sm-12 col-lg-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 text-center">
                                    <!-- remove button -->
                                    <a href="javascript:void(0)" title="Clear Images" data-bs-toggle="tooltip" id="remove-picture" class="js-file-input-btn-multiple-list-static-remove-picture hide btn btn-secondary mt-4 text-center">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-12 col-lg-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 text-center">
                                    <!-- remove button -->
                                    <a href="javascript:void(0)" title="Clear Images" data-bs-toggle="tooltip" id="remove-banner" class="js-file-input-btn-multiple-list-static-remove-banner hide btn btn-secondary mt-4 text-center">
                                        <i class="fi fi-close mx-auto"></i>
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-12 col-lg-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2 text-center">
                                    <!-- remove button -->
                                    <a href="javascript:void(0)" title="Clear Images" data-bs-toggle="tooltip" id="remove-thumb" class="js-file-input-btn-multiple-list-static-remove-thumb hide btn btn-secondary mt-4 text-center">
                                        <i class="fi fi-close mx-auto"></i>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-sm-12 col-lg-6">
                    <div class="mb-3 row">
                        <label class="col-sm-12 col-lg-3 col-form-label-sm text-lg-end text-light fw-bold">Detail :</label>
                        <div class="col-sm-12 col-lg-9">
            ...
            <div class="mb-2 row">
                <div class="col-12 justify-content-end d-flex align-items-end">
                    <x-button-submit-loading 
                        ...
                        :form_id="_('route-map-create-form')"
                        :fieldset_id="_('route-map-create')"
                        :text="_('Save')"
                    />
                    <button type="reset" class="btn btn-light btn-sm w--10 align-self-end border-radius-10" onClick="resetImage()">Reset</button>
                </div>
            </div>
        </fieldset>
    </form>
