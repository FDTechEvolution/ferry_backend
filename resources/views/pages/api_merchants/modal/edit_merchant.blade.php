        ...
        <div class="row">
            <div class="col-12 mb-2">
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="name" name="name" value="{{$apiMerchant->name}}"
                        required>
            ...
            <div class="col-12 mb-2">
                <div class="form-floating">
                    <input type="text" class="form-control" id="code" name="code" value="{{$apiMerchant->code}}"
                        disabled>
            ...
            <div class="col-12 mb-2">
                ...
                <div class="form-check mb-2">
                    <input class="form-check-input form-check-input-success" type="checkbox" value="Y" id="isopenchild"
                        name="isopenchild" @checked($apiMerchant->isopenchild=='Y')>
                ...
                <div class="form-check mb-2">
                    <input class="form-check-input form-check-input-success" type="checkbox" value="Y" id="isopeninfant"
                        name="isopeninfant" @checked($apiMerchant->isopeninfant=='Y')>
                ...
                <div class="form-check mb-2" style="display: none;">
                    <input class="form-check-input form-check-input-success" type="checkbox" value="Y"
                        id="isopendiscount" name="isopendiscount" @checked($apiMerchant->isopendiscount=='Y')>
            ...
            <div class="col-12 mb-2">
                <div class="form-floating mb-3">
                    <textarea class="form-control" id="description" name="description"
                        style="height: 100px">{{$apiMerchant->description}}</textarea>
