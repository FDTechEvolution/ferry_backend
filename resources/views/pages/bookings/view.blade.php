        ...
        <div class="col-12 col-lg-9 text-end">
            <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                @if ($booking['ispayment'] == 'Y')
                    ...
                    <a href="{{ route('print-ticket', ['bookingno' => $booking['bookingno']]) }}" class="btn btn-dark"
                        rel="noopener" target="_blank"><i class="fa-solid fa-print"></i> Send Ticket Email</a>
                @endif
                    ...
                    <div class="row">
                        <div class="col-12">
                            <span>Payment method: <span
                                    class="badge bg-primary">{{ $payment->payment_method }}</span></span>
                            <span> Payment date: <span
                                    class="badge bg-primary">{{ date('d-m-Y', strtotime($payment->payment_date)) }}</span></span>
