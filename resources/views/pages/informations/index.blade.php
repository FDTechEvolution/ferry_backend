...
@section('page-title')
    <h1 class="ms-2 mb-0" id="station-page-title"><span class="text-main-color-2">Information</span> manager</h1>
    <x-a-href-green :text="_('Add')" :href="route('information-create')" :target="_('_self')" class="ms-3 btn-sm w--10" />
@stop
                        ...
                        <tbody>
                            @foreach ($informations as $index => $item)
                                <tr class="" id="row-{{ $index }}">
                                    ...
                                    <td>
                                        <x-action-edit class="me-2" :url="route('information-edit', ['information' => $item])" id="btn-information-edit" />
                                        <x-action-delete :url="route('information-delete', ['id' => $item['id']])" :message="_('Are you sure? Delete this item.?')" />
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
