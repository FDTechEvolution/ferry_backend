	...
	<div class="modal-dialog">
		<div class="modal-content">
                ...
                @csrf
                    <div class="row g-3 mb-3">
                        <div class="col-xl-6">
                            ...
                            <input required id="account_first_name" name="firstname" type="text" class="form-control form-control-sm">
                        </div>
                        <div class="col-xl-6">
                            <label for="account_last_name" class="form-label mb-0">นามสกุล</label>
                            <input required id="account_last_name" name="lastname" type="text" class="form-control form-control-sm">
                        </div>
                    </div>

                    <div class="mb-3">
                        <label for="account_email" class="form-label mb-0">อีเมล์</label>
                        <input required id="account_email" name="email" type="email" class="form-control form-control-sm">
                    </div>

                    <div class="mb-3">
                        <label for="account_role" class="form-label mb-0">ระดับ</label>
                        <select require name="role" id="account_role" class="form-select form-select-sm">
			...
			<div class="modal-footer">
                ...
                <button type="submit" class="btn btn-sm btn-primary" id="btn-submit-form">
