...
@section('content')
    <div class="row">
        <div class="col-12">
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <table class="table-datatable table table-datatable-custom" data-lng-empty="No data available in table"
                        ...
                        data-column-search="false" data-row-reorder="false" data-col-reorder="fasle" data-responsive="true"
                        data-enable-paging="true" data-enable-col-sorting="false" data-autofill="false" data-group="false"
                        ...
                        data-options='["copy", "print"]' data-custom-config='{}'>
                        <thead>
                            <tr>
                                    ...
                                    <td>
                                        <label class="align-items-center col-form-label-sm text-center">
                                            <input class="d-none-cloaked" type="checkbox" name="switch-checkbox"
                                                value="{{ $table->id }}" @checked($table->isactive == 'Y')
                                                onClick="showInHomepage(this)">
                                            <i class="switch-icon switch-icon-primary ms-3 ms-lg-0"></i>
                                        </label>
                                    </td>
                                    <td>{{ $table->sort }}</td>
                                    <td>
                                        <x-action-edit class="me-2" :url="_('javascript:void(0)')" id="btn-time-table-edit"
                                            onClick="updateEditData({{ $index }})" />
                                        <x-action-delete :url="route('time-table-delete', ['id' => $table->id])" :message="_('Are you sure? Delete this time table ?')" />
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
