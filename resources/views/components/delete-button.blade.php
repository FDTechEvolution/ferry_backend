...
<a href="javascript:void()0;"
    ...
    data-ajax-confirm-title="กรุณายืนยันการลบข้อมูล"
    ...
    data-ajax-confirm-btn-no-icon="fi fi-close" data-ajax-confirm-callback-function="send_delete"
    {{ $attributes->merge(['class' => 'text-danger js-ajax-confirm']) }} 
    />
...
<form action="{{$url}}" method="POST" id="frm-{{$id}}">
    @method('delete')
    @csrf
</form>