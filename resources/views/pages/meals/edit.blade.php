                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 px-4" id="edit-meal-input">
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control form-control-sm" id="edit-meal-detail" data-set="description" name="detail" rows="7"></textarea>
                            </div>
                        </div>
                        <div class="mb-4 row">
                            ...
                            <label class="col-sm-1 col-form-label-sm text-start pe-1">
                                <img src="../assets/images/no_image_icon.svg" id="icon-image-show-edit" width="22" height="22">
                            </label>
                            <div class="col-sm-7 ps-0 pe-1">
                                <select class="form-select form-select-sm" id="meal-icon-edit" name="icon">
