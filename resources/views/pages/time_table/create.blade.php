            ...
            <div class="mb-2 row">
                ...
                <div class="col-sm-12 col-lg-6 justify-content-end d-flex align-items-end">
                    <x-button-submit-loading 
                        ...
                        :form_id="_('time-table-create-form')"
                        :fieldset_id="_('time-table-create')"
                        :text="_('Save')"
                    />
                    <button type="reset" class="btn btn-light btn-sm w--20 align-self-end border-radius-10" onClick="resetImage()">Reset</button>
                </div>
            </div>
        </fieldset>
    </form>
