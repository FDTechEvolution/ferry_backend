    ...
    <div class="col-12 col-lg-5 d-lg-flex">
        <div class="w-100 align-self-center text-center-md text-center-xs p-2">
            ...
            <div class="accordion" id="accordionAccount">
                ...
                <form novalidate action="{{ route('authenticate') }}" method="POST" class="collapse bs-validate show" id="accordionAccountSignIn" data-bs-parent="#accordionAccount">
                @csrf
                    <div class="p-5 pb-3 border-radius-30 d-inline-block bg-white text-dark w-100 max-w-600 mb-4">
                        ...
                        <div class="ms-1 mb-2 text-start">
                            <svg width="18px" height="18px" xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-shield-lock" viewBox="0 0 16 16">  
                            ...
                            <a href="#accordionAccountPasswd" data-bs-toggle="collapse" aria-expanded="true" aria-controls="accordionAccountPasswd" class="text-dark">Forget Password?</a>
                        </div>
                ...
                <form novalidate class="collapse bs-validate" method="POST" action="{{ route('password-email') }}" id="accordionAccountPasswd" data-bs-parent="#accordionAccount">
                @csrf
                    <div class="p-5 pb-3 border-radius-30 d-inline-block bg-white text-dark w-100 max-w-600 mb-4">
                        <div class="text-center mb-5">
                        ...
                        <!-- email address -->
                        <div class="form-floating mb-4">
                            <input required type="email" name="email" class="form-control rounded-pill" id="account_email" placeholder="Email address">
                        ...
                        <div class="ms-1 mb-2 text-start">
                            ...
                            <a href="#accordionAccountSignIn" data-bs-toggle="collapse" aria-expanded="true" aria-controls="accordionAccountSignIn" class="text-dark">Back to login</a>
                        </div>
