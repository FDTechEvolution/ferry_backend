                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 px-4" id="edit-meal-input">
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" required class="form-control form-control-sm w--40" data-set="price" id="edit-meal-price" name="price" value="{{ $meal['amount'] }}">
                            </div>
                        </div>
                        <div class="mb-4 row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="row" id="current-image">
                                    <div class="col-10 col-lg-6">
                                        <div class="position-relative hide-empty mt-2">
                                            <div class="d-flex clearfix position-relative show-hover-container shadow-md mb-2 rounded">
                                                <div class="position-relative d-inline-block bg-cover" id="edit-image-cover" style="width: 50%;">
