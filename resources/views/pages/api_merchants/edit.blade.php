...
@section('page-title')
<h1 class="ms-2 mb-0" id="promotion-page-title"><span class="text-main-color-2">{{$apiMerchant->name}}</span> API
    Setting</h1>
@stop
...
<div class="row mb-3">
    <div class="col-2">
        <a href="{{ route('api.index') }}" class="btn btn-secondary"><i class="fa-solid fa-circle-left"></i> Back to all
            API</a>
    </div>
