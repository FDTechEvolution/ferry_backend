        ...
        <div class="col-12 mb-2 col-lg-3">
            <div class="form-floating mb-3">
                <select class="form-select" id="station_to_id" name="st">
                    <option value="all" selected>-- Show all stations --</option>
    ...
    <div class="row mt-3">
        <div class="col-12">
            <div id="to-route-list" class="table-responsive">
                ...
                <table class="table table-datatable-custom table-striped table table-align-middle table-bordered" id="route-datatable"
