                ...
                <div class="row">
                    <div class="col-12 col-md-4">
                        <div class="form-floating mb-3">
                            <select class="form-select" id="station_from_id" name="station_from_id">
                                @foreach ($stationFroms as $station)
                                    <option value="{{ $station->id }}" @selected($stationFromId == $station->id)>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="form-floating mb-3">
                            <select class="form-select" id="station_to_id" name="station_to_id">
