            ...
            <fieldset id="station-create">
                <div class="row bg-transparent mt-lg-5">
                    <div class="col-12 mx-auto">
                        <h1 class="fw-bold text-second-color mb-4 ms-lg-4">Add new station</h1>

                        <div class="row">
                            <div class="col-11 mx-auto col-lg-6 px-lg-6 border-end">
                                <div class="mb-3 row">
                            ...
                            <div class="col-11 mx-auto col-lg-6 px-lg-6">
                                <div class="mb-3 row">
