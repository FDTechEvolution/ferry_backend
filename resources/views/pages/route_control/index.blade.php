                ...
                >
                    ...
                    <tbody id="tbody-route">
                        @foreach($routes as $index => $route)
                            <tr class="text-center" data-from="{{ $route['station_from']['id'] }}" data-to="{{ $route['station_to']['id'] }}">
                                <td>
...
<a href="#"
    ...
    data-ajax-confirm-title="Please Confirm"
    data-ajax-confirm-body="Are you sure? Delete this route ?"
