                ...
                <tbody id="tbody-route">
                    ...
                    <tr class="text-center align-middle" data-from="{{ $route['station_from']['id'] }}"
                        ...
                        <td class="p-0 align-middle">
                            <i @class([ 'fa-solid fa-circle' , 'text-success'=> sizeof($route['meal_lines']) > 0,
                                'text-secondary' => sizeof($route['meal_lines']) <= 0, ]) data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Meal on board">
                            </i>
                        </td>
                        <td class="p-0 align-middle">
                            <i @class([ 'fa-solid fa-circle' , 'text-success'=> sizeof($route['activity_lines']) > 0,
                                'text-secondary' => sizeof($route['activity_lines']) <= 0, ]) data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="Activity">
                            </i>
                        </td>
                        <td class="align-middle">
                            <x-route-addon-active :routeAddons="$route['routeAddons']" :name="_('Shuttle Bus From')"
                                :type="_('shuttle_bus')" :subtype="_('from')" />
                        </td>
                        <td class="align-middle">
                            <x-route-addon-active :routeAddons="$route['routeAddons']" :name="_('Shuttle Bus To')"
                                :type="_('shuttle_bus')" :subtype="_('to')" />
                        </td>
                        <td class="align-middle">
                            <x-route-addon-active :routeAddons="$route['routeAddons']" :name="_('Long Tail Boat From')"
                                :type="_('longtail_boat')" :subtype="_('from')" />
                        </td>
                        <td class="align-middle">
                            <x-route-addon-active :routeAddons="$route['routeAddons']" :name="_('Long Tail Boat To')"
                                :type="_('longtail_boat')" :subtype="_('to')" />
                        </td>
                        <td class="align-middle">
                        ...
                        <td class="align-middle">
                            ...
                            <x-action-delete :url="route('route-delete', ['id' => $route['id']])"
...
<script>
    const icons = {{ Js::from($icons) }}
        ...
        $(document).ready(function() {
            ...
            $('#txt-station-from').text($('#station_from option:selected').text());
            $('#txt-station-to').text($('#station_to option:selected').text());
