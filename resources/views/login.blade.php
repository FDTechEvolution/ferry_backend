...
<div class="d-lg-flex text-white min-vh-100" style="background: #eeeee8;">
    ...
    <div class="col-12 col-lg-5 d-lg-flex">
        <div class="w-100 align-self-center text-center-md text-center-xs p-2">
            ...
            <form novalidate action="#" method="POST" class="bs-validate p-5 pb-3 border-radius-30 d-inline-block bg-white text-dark w-100 max-w-600 mb-4">
                ...
                <div class="input-group-over">
                    <div class="form-floating mb-4">
                        <input required placeholder="Password" id="account_password" name="account_password" type="password" class="form-control rounded-pill">
