                    ...
                    <div class="col-12">
                            ...
                            <div class="col-12 px-4">
                                <div class="mb-4 row">
                                    <div class="col-12 mb-2 col-lg-4">
                                        <div class="form-floating mb-3">
                                            <x-element.dropdown-station label="Station From" name="station_from"
                                                :data=$sections selected="" required=true />
                                        </div>
                                    </div>

                                    <div class="col-12 mb-2 col-lg-4">
                                        <div class="form-floating mb-3">
                                            <x-element.dropdown-station label="Station To" name="station_to"
                                                :data=$sections selected="" required=true />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 mb-2 col-lg-4">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="partner_id">Partner <strong
                                ...
                                <div class="mb-2 row">
                                    <div class="col-sm-12 col-md-6 col-lg-2">
                                        <label class="col-form-label-sm text-start fw-bold">Depart Time <strong
                                                class="text-danger">*</strong></label>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-12 col-lg-5">
                                        ...
                                        <div class="dropdown">
                                            <a class="btn btn-outline-dark btn-sm dropdown-toggle w-100" href="#"
                                                role="button" id="dropdownMeal" data-bs-toggle="dropdown"
                                                aria-expanded="false" data-bs-offset="0,6">
                                                Select meal
                                                <span class="group-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px"
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-12 col-md-3 col-lg-3">
                                        ...
                                        <div class="dropdown">
                                            <a class="btn btn-outline-dark btn-sm dropdown-toggle w-100" href="#"
                                                role="button" id="dropdownIcons" data-bs-toggle="dropdown"
                                                aria-expanded="false" data-bs-offset="0,6">
                                                Select icon
                                                <span class="group-icon">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px"
                                            ...
                                            <ul class="dropdown-menu shadow-lg p-1 w-100 dd-overflow-y"
                                                ...
                                                @if($index == 8)
                                                <li>
                                                    <hr class="dropdown-divider my-3" style="border-color: #afafaf;">
                                                </li>
                                                @endif
                                                @endforeach
                                            </ul>
                                            ...
                                            <div class="col-5">
                                                <label class="d-flex align-items-center mb-3">
                                                    <input class="d-none-cloaked" type="checkbox"
                                                        id="route-status-switch" name="status" value="1" checked>
                        ...
                        <div class="row mb-4">
                            <div class="col-12 col-lg-6 px-4">
                                <div class="row border rounded bg-gray-100">
                                    ...
                                    <div class="col-12" style="display: none;" id="box_isinformation_from_active">
                                        <div class="row">
                                            <div class="col-12 mb-2">
                                                <textarea class="form-control" id="information_from"
                                                    name="information_from" rows="3"></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-12 col-lg-6 px-4">
                                <div class="row border rounded bg-gray-100">
                                    ...
                                    <div class="col-6">
                                        <label class="d-flex align-items-center mb-3">
                                            <input class="d-none-cloaked" type="checkbox" name="isinformation_to_active"
                                                id="isinformation_to_active" value="Y" data-action="boxswitch">
                                            <i class="switch-icon switch-icon-primary switch-icon-sm"></i>
                                            <span class="px-3 user-select-none">On/Off</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-12" style="display: none;" id="box_isinformation_to_active">
                                        <div class="row">
                                            <div class="col-12 mb-2">
                                                <textarea class="form-control" id="information_to" name="information_to"
                                                    rows="3"></textarea>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row mb-4">
                                    ...
                                    <div class="col-6">
                                        <label class="d-flex align-items-center mb-3">
                                            <input class="d-none-cloaked" type="checkbox"
                                                ...
                                                id="{{ $info['key'] }}_isactive_from" value="Y" data-action="boxswitch">
                                            <i class="switch-icon switch-icon-primary switch-icon-sm"></i>
                                            <span class="px-3 user-select-none">On/Off</span>
                                        </label>
                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-floating mb-3">
                                                    <textarea class="form-control"
                                                        id="{{ $info['key'] }}_mouseover_from"
                                                        name="{{ $info['key'] }}_mouseover_from"
                                                        style="height: 100px"></textarea>
                                                    <label for="{{ $info['key'] }}_mouseover_from">Mouseover</label>
                                                </div>
                                            </div>
                            ...
                            <div class="col-12 col-lg-6 px-4">
                                <div class="row border rounded bg-gray-100">
                                    ...
                                    <div class="col-6">
                                        <label class="d-flex align-items-center mb-3">
                                            <input class="d-none-cloaked" type="checkbox"
                                                ...
                                                id="{{ $info['key'] }}_isactive_to" value="Y" data-action="boxswitch">
                                            <i class="switch-icon switch-icon-primary switch-icon-sm"></i>
                                            <span class="px-3 user-select-none">On/Off</span>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-12" style="display: none;" id="box_{{ $info['key'] }}_isactive_to">
                                        <div class="row">
                                            <div class="col-12 col-lg-5">
                                                <div class="form-floating mb-3">
                                                    <input type="number" class="form-control"
                                            ...
                                            <div class="col-12">
                                                <div class="form-floating mb-3">
                                                    <textarea class="form-control" id="{{ $info['key'] }}_mouseover_to"
                                                        name="{{ $info['key'] }}_mouseover_to"
                                                        style="height: 100px"></textarea>
                                                    <label for="{{ $info['key'] }}_mouseover_to">Mouseover</label>
                                                </div>
                                            </div>
                                            <div class="col-12 col-lg-12">
                                                <div class="form-floating mb-3">
                        ...
                        <div class="row">
                            <div class="col-12 mt-4 text-center">
                                <x-button-submit-loading class="btn-lg w--30 me-4 button-orange-bg"
                                    :form_id="_('route-create-form')" :fieldset_id="_('route-create')"
                                    :text="_('Add')" />
