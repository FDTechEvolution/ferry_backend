            ...
            <fieldset id="">
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="mb-4 row">
                            <label class="col-12 col-md-4 col-form-label-sm text-start fw-bold text-white">Station From *
                                :</label>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="mb-4 row">
                            <label class="col-md-4 col-12 col-form-label-sm fw-bold text-white">Depart Date* :</label>
