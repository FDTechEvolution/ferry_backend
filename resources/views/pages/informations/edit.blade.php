...
@section('content') 
<form novalidate class="bs-validate" id="frm-information-update" method="POST" action="{{ route('information-update',$information->id) }}">
    @csrf
    ...
    <div class="row mt-4"> 
        <div class="col-md-8 col-sm-10 col-12">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-8">
                    <textarea class="form-control" id="body" name="body" rows="4" required>{{$information->body}}</textarea>
                </div>
            </div>
            <hr/>
            <div>
