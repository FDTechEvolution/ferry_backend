                    ...
                    <tbody>
                        @foreach($s_info as $index => $info)
                            <tr class="text-center" id="station-row-{{ $index }}">
                                ...
                                <td>
                                    <a href="javascript:void(0)" class="me-2" data-bs-toggle="modal" data-bs-target="#modalLong2" onClick="setModalContent({{ $index }})">
                                ...
                                <td>
                                    ...
                                    />
                                    <x-action-delete 
                                        :url="route('station-delete', ['id' => $info['id']])"
