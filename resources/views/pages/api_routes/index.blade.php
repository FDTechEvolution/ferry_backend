                ...
                <tbody>
                    @foreach ($routes as $index => $item)
                        ...
                        <tr>
                            ...
                            <td><input type="number" class="form-control form-control-sm input-regular" id="regular-{{ $index }}" data-index="{{ $index }}" value="{{ intval($item['regular_price']) }}"></td>
                            <td><input type="number" class="form-control form-control-sm input-discount" id="discount-{{ $index }}" data-index="{{ $index }}" value="{{ intval($item['discount']) }}"></td>
                            ...
                            <td class="text-center">
                                <label class="d-flex justify-content-center align-items-center mt-2">
                                    <input class="d-none-cloaked section-isactive" type="checkbox" name="isactive" value="" @checked(old('isactive', $item['isactive'] == 'Y')) />
