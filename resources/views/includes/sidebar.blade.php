  ...
  -->
        <nav class="nav-deep nav-deep-sm nav-deep-light">
            <ul class="nav flex-column">
                <li class="nav-item text-secondary text-center">
                    168 API
                </li>
                <li class="nav-item {{ (request()->is('changeBooking*')) ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('changeBooking.index') }}">
                        <i class="fi fi-star-full"></i>
                        <span>Booking</span>
                    </a>
                </li>
                <li class="nav-item {{ (request()->is('changeRoute*')) ? 'active' : '' }}">
                    <a class="nav-link" href="{{ route('changeRoute.index') }}">
                        <i class="fi fi-star-full"></i>
                        <span>Route</span>
                    </a>
                </li>
                ...
                <li class="nav-item py-0" role="presentation">
                    <hr class="my-2 border-0 border-top border-1 border-secondary opacity-100">
                </li>
    ...
    <div class="d-flex align-self-baseline w-100 py-3 px-3 border-top border-light small">
        ...
        <p class="d-inline-grid gap-auto-3 mb-0">
            <x-ajax-button-confirm class="link-normal" :url="route('logout')" :message="_('Logout?')" :text="_('Logout')" />
        </p>
